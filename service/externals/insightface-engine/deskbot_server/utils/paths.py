...
# synced: 2026-08-30
# 分叉点: 与源文件差异仅此一处（parents[3]→parents[2]，根目录指向本服务），重新同步时手工重放
...
# externals/insightface-engine/ 独立服务根（含本服务 config.yaml、models/、data/）
# deskbot_server/utils/paths.py → parents[2] == externals/insightface-engine/
